...
<tr>
    ...
    <td>
        ...
        <g:else>
            ...
            <p style="width:450px;margin-bottom: 5px">This is the XML that you need to add inside a <tt>&lt;category&gt;</tt> in the file<br/>
            ...
            can only create simple rules. See <a href="http://www.languagetool.org/development/">our development documentation</a>
            for more features.</p>
